...
public class Mandalore {
    ...
    private ArrayList<EdificacionesMandalorians> EdificacionesEsqueletos = new
    ...
    public ArrayList<EdificacionesMandalorian> getEdificacionesEsqueletos() {
    ...
    public void setEdificacionesEsqueletos(ArrayList<EdificacionesMandalorian> EdificacionesEsqueletos) {
